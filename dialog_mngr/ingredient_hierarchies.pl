...
typeIngredient('sirloin strips', 'meat').
typeIngredient('sausage meat', 'meat').
typeIngredient('chorizo', 'meat').
typeIngredient('sausages', 'meat').
typeIngredient('steak', 'meat').
typeIngredient('nduja', 'meat').
...
typeIngredient('cod', 'non-vegetarian'). 
typeIngredient('parma ham', 'non-vegetarian').
typeIngredient('cod fillet', 'non-vegetarian').
typeIngredient('sirloin strips', 'non-vegetarian').
typeIngredient('sea bass', 'non-vegetarian').
typeIngredient('sea bass fillets', 'non-vegetarian').
typeIngredient('red sockeye', 'non-vegetarian').
typeIngredient('mussels', 'non-vegetarian').
typeIngredient('clams', 'non-vegetarian').
typeIngredient('sausage meat', 'non-vegetarian').
typeIngredient('tuna', 'non-vegetarian').
typeIngredient('chorizo', 'non-vegetarian').
typeIngredient('gelatin', 'non-vegetarian').
typeIngredient('sausages', 'non-vegetarian').
typeIngredient('steak', 'non-vegetarian').
typeIngredient('nduja', 'non-vegetarian').
...
typeIngredient('cod', 'non-vegan'). 
typeIngredient('parma ham', 'non-vegan').
typeIngredient('cod fillet', 'non-vegan').
typeIngredient('sirloin strips', 'non-vegan').
typeIngredient('sea bass', 'non-vegan').
typeIngredient('sea bass fillets', 'non-vegan').
typeIngredient('red sockeye', 'non-vegan').
typeIngredient('mussels', 'non-vegan').
typeIngredient('clams', 'non-vegan').
typeIngredient('sausage meat', 'non-vegan').
typeIngredient('tuna', 'non-vegan').
typeIngredient('chorizo', 'non-vegan').
typeIngredient('gelatin', 'non-vegan').
typeIngredient('sausages', 'non-vegan').
...
%
% Project Assignment: Capability 7: Filter Recipes by Dietary Restrictions
%
 ...
 *
 * Succeeds if recipe with identifier RecipeID uses ingredient (type) Ingr.
 *
 * @RecipeID	An identifier of a recipe.
 * @Ingr	An ingredient (type).
**/
...
conflict('gluten-free', 'gluten').
conflict('gluten', 'gluten-free').
